...
class VendingMachine
{
    ...
    public static void inputCoins(Scanner sc, VendingExample VM){
        System.out.println("Insert coins in the form of: PENNY, NICKEL, DIME and QUARTER");
    ...
    public static String selectItems(Scanner sc, VendingExample VM){
        ...
        System.out.println("COKE: Coke(25)");
        System.out.println("PEPSI: Pepsi(35)");
        System.out.println("SODA: Soda(45)");
